...
def FindMin(alfa, X0, N):
    X1=fXNew(alfa, X0, N)
    print('FindMin: X0=',X0,' alfa=',alfa,' X=',X1, ' N=',N)
...
def main():
    ...
    if FN==1:
        ...
        x1 = 1 #3#1.5#-3#1.5 # uz sys alg eqs
        x2 = 2#4#3.5#5#3.5 # uz sys alg eqs
    eps1 = 0.000001#0.001
    eps2 = 0.000001
    #gradF1 = calc_F1(x1)
    #gradF2 = calc_F2(x2)
    ...
    while contin==1:
        ...
        for i in range(1, n+1):
            alfa=fmin_powell(FindMin, 0.5, (Xnext, i,))
            Xnext= fXNew(alfa, Xnext, i)
            x1=Xnext[1-1]
            x2=Xnext[2-1]
