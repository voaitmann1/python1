...
#
print("part 1 of 2 (of 2nd eq of side move - dwx)")
#
...
print(X2)
print("Y2="+str(Y2))
A2=myLinAlg.multiply(myLinAlg.transpose(X2), X2)
B2=myLinAlg.multiply(myLinAlg.transpose(X2), Y2)
...
MaxQIters=20
eps=1E-6
X0=myLinAlg.VectorOfZeros(len(B2))
Mx=myLinAlg.Seidel(A2, B2, X0, eps, MaxQIters, howAnywaySeidel0NurIfDetET01AnywayMatrix2)
print("Mx="+str(Mx)+" ini vector="+str(X0))
print("A2*Mx="+str(myLinAlg.multiply(A2,Mx))+" B2="+str(B2))
print("MQError="+str(myLinAlg.LinEqErrVec(A2, B2, Mx))+" err="+str(myLinAlg.LinEqErr(A2, B2, Mx)))
X0=myLinAlg.VectorOfOnes(len(B2))
Mx=myLinAlg.Seidel(A2, B2, X0, eps, MaxQIters, howAnywaySeidel0NurIfDetET01AnywayMatrix2)
print("Mx="+str(Mx)+" ini vector="+str(X0))
print("A2*Mx="+str(myLinAlg.multiply(A2,Mx))+" B2="+str(B2))
print("MQError="+str(myLinAlg.LinEqErrVec(A2, B2, Mx))+" err="+str(myLinAlg.LinEqErr(A2, B2, Mx)))
...
#
C_wx_side_fiTR_Var2ExampleNotSys=Mx#Mx above#=myLinAlg.Seidel(A2, B2, X0, eps, MaxQIters, howAnywaySeidel0NurIfDetET01AnywayMatrix2)
#
...
#
print("part 2 of 2 (2nd eq of sode move)")
#
A_wx_to_fiTR  =  fA_y_to_x(w_ctrl, delta_fi_TR__data, dwx__data, dt)
fi_wx_to_fiTR = ffi_y_to_x(w_ctrl, delta_fi_TR__data, dwx__data, dt)
#
...
#Mx_side_Vz_delta_fiTR=Mx
#
C_wx_side_fiTR_Var1SysNotExample=Mx#Mx above#=myLinAlg.Seidel(A2, B2, X0, eps, MaxQIters, howAnywaySeidel0NurIfDetET01AnywayMatrix2)
#
...
#Mx_side_Vz_delta_fiTR=Mx
#
C_wy_side_fiTR_Var2ExampleNotSys=Mx#Mx above#=myLinAlg.Seidel(A2, B2, X0, eps, MaxQIters, howAnywaySeidel0NurIfDetET01AnywayMatrix2)
#
...
#Mx_side_Vz_delta_fiTR=Mx
#
C_wx_side_fiTR_Var1SysNotExample=Mx=myLinAlg.Seidel(A2, B2, X0, eps, MaxQIters, howAnywaySeidel0NurIfDetET01AnywayMatrix2)
#
C_wx_side_Vz_fiTR_Var1SysNotExample=C_Wx_side_fiTR[1-1]
C_wx_side_wx_fiTR_Var1SysNotExample=C_wx_side_fiTR[2-1]
C_wx_side_wy_fiTR_Var1SysNotExample=C_wy_side_fiTR[3-1]
...
#Mx_side_Vz_delta_fiTR=Mx
#
C_Vz_side_delta_k_=Mx#Mx above#=myLinAlg.Seidel(A2, B2, X0, eps, MaxQIters, howAnywaySeidel0NurIfDetET01AnywayMatrix2)
#
...
#
#
print("part 2 of 2 (1st eq of side move)")
#
A_wx_to_fiTR  =  fA_y_to_x(w_ctrl, delta_fi_TR__data, dwx__data, dt)
fi_wx_to_fiTR = ffi_y_to_x(w_ctrl, delta_fi_TR__data, dwx__data, dt)
#
...
#Mx_side_Vz_delta_fiTR=Mx
#
C_Vz_side_fiTR_=Mx#Mx above#=myLinAlg.Seidel(A2, B2, X0, eps, MaxQIters, howAnywaySeidel0NurIfDetET01AnywayMatrix2)
#
...
#
#Eqa Vx
print("1st equation of longitudial move")
#----------------------------------------------
print("dVx/dt = XVx*dVx + XVy*dVy + Xwz*dwz + XW*dW+Xth*dtheta + X_delta_v*delta_v + Xfi*delta_FI_MR")
#
...
#M_side=[[-3.25, -3.25, -0.5, -1], [-0.625, -4.25, 1.5, 0], [0.25, 1.25, -2.75, 0], [0, 1, -0.017, 0]]
M_side=[[-1.5, -1.5, 1, -0.5], [0.563, -1, -2.047, 0], [0.125, -1.25, -1.375, 0], [0, 1, -0.017, 0]]
#A=[[1, 3, 1, 4],[2, 4, 1, 1],[3, 5, 4, 2],[4, 3, 1, 2]]
coefs=myLinAlg.fKrylov(M_side)
#coefs=myLinAlg.fKrylov(A)
