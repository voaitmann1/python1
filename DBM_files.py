...
x.im=30
print(x)
conn = sqlite3.connect('C:\\temp\\orders.db')
#conn = sqlite3.connect(:memory:) so can in RAM!
cur = conn.cursor()#obj for queries to base
...
print(all_results)
#
#filedb = pickle.open('c:\temp\CmxSer', 'c')
#P = pickle.Pickler('c:\temp\CmxSer','c')
pickle.Pickler(x,'c:\temp\CmxSer')
