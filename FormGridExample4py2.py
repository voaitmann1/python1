...
class TableGridView:
    ...
    def EventHandle_LeftClick_ContentCell(self, event):
        ...
        #modify(event.widget['relief']=self.gui.SUNKEN)
        zero=0
        event.widget.configure(relief=self.gui.SUNKEN)
        #NameText="Active"
...
DfltWidth=20
rowOrder_LC0_CL1=1 #rowOrder_LC0_CL1=1

#def __init__(self, mstr,   gui, contentSize, headerSize, activeRows, Align_Left1Top2Bottom3Right4=0, DfltWidth=40, RowOrder_LC0_CL1=1)
#
#grid =    TableGridView(frame_b, tk,        size, headerSize, ActiveCell, Align_Left1Top2Bottom3Right4,   DfltWidth, rowOrder_LC0_CL1)
grid =    TableView(frame_b, tk,        size, headerSize, ActiveCell, Align_Left1Top2Bottom3Right4,   DfltWidth, rowOrder_LC0_CL1)
#
