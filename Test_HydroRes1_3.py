...
print("now pipeline:")
R1.Show_WithSubElts()
R1.elems[1-1].k=11#R11.k=11
R1.elems[1-1].curN=11
...
R1.elems[2-1].AddParSmart(R122,0,0,vsh1)
print("must be added R122 to R121 par")
R1.Show_WithSubElts()
R1.elems[2-1].k=12#R11.k=11
R1.elems[2-1].curN=12
(R1.elems[2-1]).elems[1-1].k=2#R11.k=11
(R1.elems[2-1]).elems[1-1].curN=121
...
print("Ns(1): Ns=",Ns)
print("Ns(11): Ns=",Ns)
Ns=R1.elems[1-1].FullPresentNsList(1)
print("Ns(1): Ns=",Ns)
print("Ns(121): Ns=",Ns)
Ns=(R1.elems[2-1]).elems[1-1].FullPresentNsList(1)
print("Ns(121): Ns=",Ns)
print("\n")
#
print("\nFirst absent N:")
N=(R1.elems[2-1]).elems[1-1].FirsrAbsentN()
print("N1(121)=",N)
print("\n")
#
#
print("\nMore complex'd pipeline: R121+suc, Now ic s'alt R121 s'complex")
(R1.elems[2-1]).elems[1-1].AddSucSmart(R122,0,0,vsh1)
(R1.elems[2-1]).elems[1-1].curN=13
((R1.elems[2-1]).elems[1-1]).elems[1-1].curN=121
((R1.elems[2-1]).elems[1-1]).elems[2-1].curN=123
R1.Show_WithSubElts()
print("\nyUpper:")
...
print("\nx:")
#x=(R1.elems[2-1]).elems[1-1].elems[2-1].vis_x(1)#10
x=(R1.elems[2-1]).elems[1-1].elems[1-1].vis_x(1)#8
print("\ny:")
#y=(R1.elems[2-1]).elems[1-1].elems[2-1].vis_y(1)#0
y=R1.elems[2-1].elems[2-1].vis_y(1)#0
#
#
print("\nStartRec")
