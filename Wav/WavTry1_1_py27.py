...
def harmonic_analysis_with_envelopes(y, fs, n_harmonics=5):
    """
...
def plot_harmonics_with_envelopes(results, summary, envelopes):
    ...
    for i, (t, comp, env, freq) in enumerate(envelopes):
        ...
        plt.plot(t, comp, label="Гармоника "+str(freq)+" Гц", alpha=0.6)
    ...
    plt.title("Суммарно: δ={:.4f}, Q={:.2f}".format(summary['delta_total'], summary['Q_total']))
