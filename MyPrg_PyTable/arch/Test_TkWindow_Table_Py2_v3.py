...
class TableView:
    def __init__(self, mstr, gui, curTable, tblInf=0, GuiControls=0, activeRows=0, DfltWidth=40):#, rowOrder_LC0_CL1=1,  sourceOrder_LC0_CL1=1):
        self.GuiControls=TableGUIControls()
        if isinstance(GuiControls, TableGUIControls):
            self.GuiControls=copy.deepcopy(GuiControls)
...
#TableView __init__(self, mstr, gui, curTable, tblInf, GuiControls, activeRows, Align_Left1Top2Bottom3Right4=0, DfltWidth=40, rowOrder_LC0_CL1=0, tblView=0,  sourceOrder_LC0_CL1=0):
grid =    TableView(   frame_b, tk,  tbl6, tblInf, guiControls)
#
