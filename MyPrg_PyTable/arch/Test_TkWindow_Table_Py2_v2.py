...
tbl6.Set_ByContentHeadered(dataSource, ColNamesRow, TableHeaders("MyShop", "Names", "Params"), 0, 0, vsh)
...
class TableGridView:
    ...
    def __init__(self, mstr, gui, curTable, tblInf, GuiControls, activeRows=0, Align_Left1Top2Bottom3Right4=0, DfltWidth=40, rowOrder_LC0_CL1=0, tblView=0,  sourceOrder_LC0_CL1=0):
        self.gui=gui
...
class TableView:
    def __init__(self, mstr, gui, curTable, tblInf=0, GuiControls=0, activeRows=0, Align_Left1Top2Bottom3Right4=0, DfltWidth=40):#, rowOrder_LC0_CL1=1,  sourceOrder_LC0_CL1=1):
...
grid =    TableView(   frame_b, tk,  tbl6)
#
