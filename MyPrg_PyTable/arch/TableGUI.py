...
class TableGridView:
    ...
    def __init__(self, mstr, gui, curTable, tblInf, GuiControls, activeRows=0, DfltWidth=40, tblView=0):
        self.gui=gui
...
class TableView:
    def __init__(self, mstr, gui, curTable, tblInf=0, GuiControls=0, activeRows=0, DfltWidth=40, vsh=0):#, rowOrder_LC0_CL1=1,  sourceOrder_LC0_CL1=1):
        self.GuiControls=TableGUIControls()
        if isinstance(GuiControls, TableGUIControls):
            self.GuiControls=copy.deepcopy(GuiControls)
        ...
        #
        #TableGridView(     self,                  mstr, gui, curTable, tblInf, GuiControls, activeRows=0, DfltWidth=40, tblView=0)
        self.grid=TableGridView(self.tableViewMainFrame, gui, curTable, tblInf, GuiControls, activeRows,   DfltWidth,    self) 
        #
        #^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
        #
        ...
        #
        StructToolbar_Col1=gui.Frame(master=self.StructToolbar,  relief=tk.RIDGE)
        StructToolbar_Col2=gui.Frame(master=self.StructToolbar,  relief=tk.RIDGE)
        StructToolbar_Col3=gui.Frame(master=self.StructToolbar,  relief=tk.RIDGE)
        StructToolbar_Col4=gui.Frame(master=self.StructToolbar,  relief=tk.RIDGE)
        #
        ...
        #
        NavigationToolbar_Line1=gui.Frame(master=self.StructToolbar,  relief=tk.RIDGE)
        NavigationToolbar_Line2=gui.Frame(master=self.StructToolbar,  relief=tk.RIDGE)
        NavigationToolbar_Line3=gui.Frame(master=self.StructToolbar,  relief=tk.RIDGE)
        #
        NavigationToolbar_Line1.pack()
        NavigationToolbar_Line2.pack()
        NavigationToolbar_Line3.pack()
        #
        self.btn_AddLine=gui.Button(master=self.frame_SupplToolbar, name="btn_AddLine", text ="Add Line", width=10)
        self.btn_InsLine=gui.Button(master=self.frame_SupplToolbar, name="btn_InsLine", text ="Ins Line", width=10)
        self.btn_DelLine=gui.Button(master=self.frame_SupplToolbar, name="btn_DelLine", text ="Del Line", width=10)
        self.btn_AddCol=gui.Button(master=self.frame_SupplToolbar, name="btn_AddCol", text ="Add Col", width=10)
        self.btn_InsCol=gui.Button(master=self.frame_SupplToolbar, name="btn_InsCol", text ="Ins Col", width=10)
        self.btn_InsCol=gui.Button(master=self.frame_SupplToolbar, name="btn_DelCol", text ="Del Col", width=10)
        self.btn_AddBoth=gui.Button(master=self.frame_SupplToolbar, name="btn_AddBoth", text ="Add Both", width=10)
        self.btn_InsBoth=gui.Button(master=self.frame_SupplToolbar, name="btn_InsBoth", text ="Ins Both", width=10)
        self.btn_DelBoth=gui.Button(master=self.frame_SupplToolbar, name="btn_DelBoth", text ="Del Both", width=10)
        #
        self.btn_ArrowUp=gui.Button(master=self.frame_SupplToolbar, name="btn_ArrowUp", text ="^", width=40)
        self.btn_ArrowUpLim=gui.Button(master=self.frame_SupplToolbar, name="btn_ArrowUpLim", text ="^^", width=8)
        self.btn_ArrowDn=gui.Button(master=self.frame_SupplToolbar, name="btn_ArrowDn", text ="v", width=40)
        self.btn_ArrowDnLim=gui.Button(master=self.frame_SupplToolbar, name="btn_ArrowDnLim", text ="vv", width=8)
        self.btn_ArrowToTheLeft=gui.Button(master=self.frame_SupplToolbar, name="btn_ArrowToTheLeft", text ="<", width=8)
        self.btn_ArrowLeftLim=gui.Button(master=self.frame_SupplToolbar, name="btn_ArrowLeftLim", text ="<<", width=8)
        self.btn_ArrowToTheRight=gui.Button(master=self.frame_SupplToolbar, name="btn_ArrowToTheLRight", text =">", width=8)
        self.btn_ArrowRightLim=gui.Button(master=self.frame_SupplToolbar, name="btn_ArrowRightLim", text =">>", width=8)
        #
...
class TableForm:
    def __init__(self, sourceTable, tblInf=0, GuiControls=0, activeRows=0, source=0, DfltWidth=40, vsh=0):
        ...
        #TableView __init__(self,  mstr,  gui,      curTable, tblInf=0,   GuiControls=0, activeRows=0, DfltWidth=40, vsh=0):
        grid =    TableView(self.frame_b,  tk,  self.curTable,  tblInf, self.guiControls, activeRows,    DfltWidth, vsh)
        #^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
