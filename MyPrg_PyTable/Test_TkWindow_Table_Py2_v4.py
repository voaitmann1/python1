...
dataSource="гриль Тефаль GC 712 OptiGril"
...
dataSource=[["Greel Tefal GC 712 OptiGril",4999,6999,"Foxtrot.ua"],
...
tblInf.repr.SetAsSimpleNumerated(1,1,1,1,1,1)
guiControls=TableGUIControls()
guiControls.Array_ActiveNText1_ActiveItemText2_Combobox3=2
print("representation to be given to fns")
if isinstance(tblInf.repr, TableRepr):
    print("TableRepr object exists")
    if isinstance(tblInf.repr.general, TableRepr_General):
        print("TableRepr_General component exists:")
        print(tblInf.repr.ToString_general())
        print(tblInf.repr.general.ToString())
    else:
        print("tblInf.repr.general is not an instance of TableRepr_General")
    if isinstance(tblInf.repr.CoLH, TableRepr_RowHeaderCell):
        print("TableRepr.CoLH component exists:")
        print(tblInf.repr.ToString_CoLH())
        print(tblInf.repr.CoLH.ToString())
    else:
        print("tblInf.repr.CoLH is not an instance of TableRepr_RowHeaderCell")
    if isinstance(tblInf.repr.LoCH, TableRepr_RowHeaderCell):
        print("TableRepr.LoCH component exists:")
        print(tblInf.repr.ToString_LoCH())
        print(tblInf.repr.LoCH.ToString())
    else:
        print("tblInf.repr.LoCH is not an instance of TableRepr_RowHeaderCell")
    if isinstance(tblInf.repr.Cont, TableRepr_ContentCell):
        print("TableRepr.LoCH component exists:")
        print("Cont self")
        print(tblInf.repr.ToString_Cont_Slf())
        print("Cont CoLH")
        print(tblInf.repr.ToString_Cont_CoLH())
        print("Cont LoCH")
        print(tblInf.repr.ToString_Cont_LoCH())
    else:
        print("tblInf.repr.Cont is not an instance of TableRepr_ContentCell")
else:
    print("tblInf.repr is not an instance of TableRepr")
print(" ")

tbl6=TableController2()
tbl6.Set_ByContentHeadered(dataSource, ColNamesRow, TableHeaders("MyShop",  "Params", "Names"), 0, 0, vsh)


vsh=1

tbl6.ToString_Cell(2, 2, tblInf.repr, vsh)
print("")
tbl6.ToString_Cell_LineOfColHeader(2, tblInf.repr, vsh)
print("")
tbl6.ToString_Cell_ColOfLineHeader(2, tblInf.repr, vsh)
print("")
...
class TableGridView:
    ...
    def __init__(self, mstr, gui, curTable, tblInf, GuiControls, activeRows=0, DfltWidth=40, tblView=0):
        ...
        vsh=1
        #
        #self.sourceOrder_LC0_CL1=sourceOrder_LC0_CL1
        #   self.rowOrder_LC0_CL1=rowOrder_LC0_CL1
        #
        #self.tblInf=TableInfo()
        #self.tblInf=TableInfo1()
        #if tblInf!=[]:
        #    self.tblInf=copy.deepcopy(tblInf)
        ...
        #self.Align_Left1Top2Bottom3Right4=self.GuiControls.Align_Left1Top2Bottom3Right4
        #
        ...
        #self.QLines=curTable.GetQLines()
        #self.QColumns=curTable.GetQColumns()
        #
        #self.QLineHeaders=headerSize.L
        #self.QColumnHeaders=headerSize.C
        #if self.tblInf.repr.GetIfLineOfColHeaderToShow()!=0 or curTable.GetIf_LineOfColHeaderExists()!=0:
        if self.repr.GetIfLineOfColHeaderToShow()!=0 or curTable.GetIf_LineOfColHeaderExists()!=0:
           self. headerSize.C=1
        else:
           self. headerSize.C=0
        #if self.tblInf.repr.GetIfColOfLineHeaderToShow()!=0 or curTable.GetIf_ColOfLineHeaderExists()!=0:
        ...
        #self.TableGUIControls=tblInf.TableGUIControls
        #
...
class TableForm:
    def __init__(self, sourceTable, tblInf=0, GuiControls=0, activeRows=0, source=0, DfltWidth=40, vsh=0):
        self.window = tk.Tk()
        #
        self.frame_a = tk.Frame(master=window,  relief=tk.RIDGE)
        self.frame_b = tk.Frame(master=window)
        self.frame_c = tk.Frame(master=window, relief=tk.GROOVE)
        ...
        if isinstance(GuiControls, tableGUIControls):
            self.guiControls=copy.deepcopy(GuiControls)
        if isinstance(tableExt, TableController2):
